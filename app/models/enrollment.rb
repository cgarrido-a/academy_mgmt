class Enrollment < ApplicationRecord
  ...
  validates :enrollment_amount, presence: true, numericality: { greater_than_or_equal_to: 0 }
  validates :total_tuition_fee, presence: true, numericality: { greater_than_or_equal_to: 0 }
